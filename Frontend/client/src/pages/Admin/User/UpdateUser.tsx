...
import { User, updateAdminUser } from "../../../services/auth";
...
const UpdateUser = () => {
  ...
  const onSubmit = async (data: User) => {
    try {
      ...
      // Nếu là admin cập nhật chính mình, không cho phép thay đổi status và role
        ...
        <div className="row justify-content-center w-100">
          <div className="col-lg-12 col-md-12">
            ...
            >
              ...
              <div className="form-group mb-5">
                <label htmlFor="address" className="fw-bold fs-5">
                  Địa chỉ
                </label>
                <input
                  type="text"
                  ...
                  className="form-control form-control-lg"
                  {...register("address", {
                    required: "Không để trống address",
                  })}
                />
                {errors?.address && (
                  <span className="text-danger mt-5">
